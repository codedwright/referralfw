<?php
    ...
    if(isset($data['guides'])) {
        if($data['guides']['linked'] == 'checked') {
            $frontpage_guides_link1 = '<a class="d-flex align-items-stretch" href="link">';
            $frontpage_guides_link2 = '<a class="d-flex align-items-stretch" href="link">';
            $frontpage_guides_link3 = '<a class="d-flex align-items-stretch" href="link">';        
