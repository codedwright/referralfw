            ...
            <article class="page col p-3 pr-lg-4">
                <div class="jumbotron p-3 p-md-5 text-light rounded bg-dark">
                    <div class="col-md-6 px-0">
                        ...
                        <p class="lead my-3">
                            We are strong believers that education and knowledge are tools to success. We want to put that tool in your hands with the following valuable resources.
                        </p>
                    </div>
                </div>
                <div class="row mb-2">
                    <div class="col-md-6">
                        <a class="card-link" href="https://referralfw.com/resources/faq/">
                    ...
                    <div class="col-md-6">
                        <a class="card-link" href="https://referralfw.com/resources/preparation/">
                            <div class="card flex-md-row mb-4 box-shadow h-md-250">
                                <div class="card-body d-flex flex-column justify-content-center">
                                    <h3 class="mb-0 text-dark">
                ...
                <div class="row mb-2">
                    <div class="col-md-6">
                        <a class="card-link" href="https://referralfw.com/resources/spotting/">
                            <div class="card flex-md-row mb-4 box-shadow h-md-250">
                                <div class="card-body d-flex flex-column justify-content-center">
                                    <h3 class="mb-0 text-dark">
                    ...
                    <div class="col-md-6">
                        <a class="card-link" href="https://referralfw.com/resources/tips/">
                            <div class="card flex-md-row mb-4 box-shadow h-md-250">
                                <div class="card-body d-flex flex-column justify-content-center">
                                    <h3 class="mb-0 text-dark">
                                        Carpet Care Tips
